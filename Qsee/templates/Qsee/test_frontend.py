...
class Testindex(unittest.TestCase):
    ...
    def test_input_form (self):
        """Please ensure server is running locally before beginning test and
        that you have installed the correct chromedriver version for your system"""

        driver = self.driver
        driver.get('http://127.0.0.1:8000/test_input/8/3/') # Test control

        driver.find_element(By.ID, 'id_result').send_keys(random.randint(27, 30))  # Random int within acceptable range
